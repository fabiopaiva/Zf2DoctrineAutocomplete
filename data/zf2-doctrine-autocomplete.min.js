...
var e={};$(a).autocomplete({minLength:2,appendTo:$(this).parent(),source:function(b,h){var a=b.term;a in e?h(e[a]):(b.select_warning_message=d,b.property=g,b.target_class=k,b.search_fields=l,b.order_by=m,$.getJSON("/zf2-doctrine-autocomplete/"+f,b,function(b,c,d){e[a]=b;h(b)}))},change:function(b,a){null==a.item&&($(this).parent().find(".zf2-doctrine-autocomplete-id").val(""),c||($(this).val(""),$(this).parent().find(".zf2-doctrine-autocomplete-msg").html(d?d:"Select in list").addClass("bg-warning")))},
select:function(b,a){$(this).parent().find(".zf2-doctrine-autocomplete-id").val("");$(this).parent().find(".zf2-doctrine-autocomplete-msg").html("").removeClass("bg-warning");if(null!=a.item.value)return $(this).val(a.item.label),$(this).parent().find(".zf2-doctrine-autocomplete-id").val(a.item.value),!1}})}})}};$(document).ready(function(){if(!$.isFunction($.fn.autocomplete))return console.log("Required jQuery UI Autocomplete"),!1;zf2DoctrineAutocomplete.init("body")});
